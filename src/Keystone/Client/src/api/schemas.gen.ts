...
export const CommandExecutionRequestSchema = {
    required: ['actionKey'],
    type: 'object',
    properties: {
        actionKey: {
...
export const CommandItemSchema = {
    required: ['actionKey', 'icon', 'label', 'link'],
    type: 'object',
    properties: {
        label: {
            type: 'string'
...
export const CommandItemsDtoSchema = {
    required: ['alias', 'commandItems', 'header'],
    type: 'object',
    properties: {
        alias: {
            type: 'string'

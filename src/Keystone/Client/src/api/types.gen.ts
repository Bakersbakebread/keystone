...
export type GetCommandsResponse = (Array<(CommandItemsDto)>);

export type GetCommandsError = (unknown);
...
export type ExecuteCommandError = (unknown);
